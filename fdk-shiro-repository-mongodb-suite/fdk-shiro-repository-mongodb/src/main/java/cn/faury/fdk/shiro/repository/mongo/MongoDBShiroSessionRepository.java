...
public class MongoDBShiroSessionRepository implements ShiroSessionRepository {
     ...
     * 默认集合名
     */
    public static final String DFT_SESSION_COLL_NAME = "FdkSessionColl";
    ...
    public void updateSession(Session session) {
        ...
        this.mongoTemplate.updateFirst(query, update, collName);
    }
    ...
    public Session getSession(Serializable sessionId) {
        ...
        Query query = new Query();
        query.addCriteria(Criteria.where("key").is(getSessionKey(sessionId)));
    ...
    public void deleteSessionOfPrincipal(Serializable principal) {
        ...
        this.mongoTemplate.remove(query, collName);
    }
