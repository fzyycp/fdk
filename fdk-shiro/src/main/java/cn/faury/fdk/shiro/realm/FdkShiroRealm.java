...
//        }
        ...
        IUserInfoBean acc = userService == null ? null : userService.getUserInfoByLoginName(loginName);
        ...
        if (acc != null) {
            ...
            // 获取用户角色
            List<IRoleInfoBean> roles = roleService == null ? null : roleService.getUserRolesByUserId(saCode, acc.getUserId());
            if (roles != null && roles.size() > 0) {
                for (IRoleInfoBean role : roles) {
...
//            ShiroKit.setShiroSessionAttr("perms", info);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        // 获取用户信息
        IUserInfoBean user = userService == null ? null : userService.getUserInfoByLoginName(upt.getUsername());
        ...
        if (user != null) {
            ...
            IUserPasswordBean pwd = userService == null ? null : userService.getUserPasswordByUserId(user.getUserId());
     ...
     * @throws AuthenticationException
     */
    protected void validateAuth(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
     ...
     * @throws AuthenticationException
     */
    protected boolean preValidateAuth(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
        return true;
    }
     ...
     * @throws AuthenticationException
     */
    protected void doValidateAuth(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
    }
     ...
     * @throws AuthenticationException
     */
    protected void afterValidateAuth(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
    }
     ...
     */
    protected void validateStatus(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
     ...
     * @throws AuthenticationException
     */
    protected boolean preValidateStatus(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
        return true;
    }
     ...
     * @throws AuthenticationException
     */
    protected void doValidateStatus(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
        // 验证是否启用
        ...
        // 验证账号是否生效
        String startDate = user.getEfctYmd();
        ...
        // 验证账号是否失效
        String endDate = user.getExprYmd();
     ...
     * @throws AuthenticationException
     */
    protected void afterValidateStatus(IUserInfoBean user, AuthenticationToken token) throws AuthenticationException {
    }
    ...
    public FdkShiroRealm setRoleService(IRoleService roleService) {
