...
/**
 * 手机端OAuth2登录验证过滤器：新浪微博
 */
public class SinaWeiboOAuth2Handler extends SsoOAuth2Handler{

    /**
     * Key键
     */
    public static final String HANDLER_KEY = "SINA_WEIBO";
    ...
    protected UserOAuthInfoBean createUserOAuthInfoBean(ServletRequest request) {
        ...
        String refreshToken = WebUtils.getCleanParam(request, DEFAULT_OAUTH2_REFRESH_TOKEN_PARAM);
        ...
        AssertUtil.assertNotEmpty(refreshToken,new TipsException(RestResultCode.CODE500.getCode(),"第三方登录授权信息获取失败","输入参数refresh_token不可以为空"));
