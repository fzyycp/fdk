...
/**
 * ShiroUtil. (Singleton, ThreadSafe)
 */
public class ShiroUtil {
	...
	public static void stop(boolean stopSessionFlag) {
		if (stopSessionFlag) {
			getSubject().getSession().stop();
		}
		getSubject().logout();
	}
	...
	public static Session createShiroSession() {
		return getSubject().getSession(true);
	}

	public static void setShiroSessionAttr(String key, Object value) {
	 ...
	 */
	public static void removeShiroSessionAttr(String key) {
		Session session = getShiroSession();
		if (session != null) {
